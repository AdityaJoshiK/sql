...
--SELECT LOANNO,BNAME FROM BORROW WHERE BNAME='ANDHERI'

/*SELECT ACTNO,AMOUNT FROM DEPOSIT
          WHERE ACTNO=106;*/

--SELECT AMOUNT,CNAME FROM BORROW WHERE AMOUNT>5000;
...
--SELECT CNAME,BNAME FROM DEPOSIT WHERE AMOUNT>400 AND ACTNO<105
